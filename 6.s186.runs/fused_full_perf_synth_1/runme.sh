...
HD_PWD='C:/Users/rob/Desktop/6.s186/6.s186.runs/fused_full_perf_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fused_full_perf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fused_full_perf.tcl
