...
HD_PWD='C:/Users/rob/Desktop/6.s186/6.s186.runs/fused_med_res_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fused_med_res.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fused_med_res.tcl
