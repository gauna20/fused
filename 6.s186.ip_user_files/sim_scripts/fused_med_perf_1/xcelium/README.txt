...
#
# Generated by export_simulation on Tue Jan 14 17:15:15 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './fused_med_perf.sh' script.

./fused_med_perf.sh -reset_run
...
./fused_med_perf.sh -noclean_files

For more information on the script, please type './fused_med_perf.sh -help'.
