...
#
# Generated by export_simulation on Tue Jan 14 17:17:33 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './fused_full_perf.sh' script.

./fused_full_perf.sh -reset_run
...
./fused_full_perf.sh -noclean_files

For more information on the script, please type './fused_full_perf.sh -help'.
